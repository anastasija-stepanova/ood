...
require_once(__DIR__ . "/canvas/DrawableInterface.php");
...
require_once(__DIR__ . "/shapes/GroupShapeInterface.php");
require_once(__DIR__ . "/shapes/MockShape.php");
...
require_once(__DIR__ . "/style/GroupFillStyle.php");
require_once(__DIR__ . "/style/GroupFillStyleEnumerator.php");
require_once(__DIR__ . "/style/OutlineStyleInterface.php");
require_once(__DIR__ . "/style/OutlineStyle.php");
require_once(__DIR__ . "/style/GroupOutlineStyle.php");
require_once(__DIR__ . "/style/GroupOutlineStyleEnumerator.php");
